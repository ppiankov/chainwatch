# Chainwatch v0.1.2: Irreversible Boundary Protection

**Version:** 0.1.2 (conceptual reframe of v0.1.1)
**Status:** Stable
...
**Same code as v0.1.1, but reframed as irreversible boundary protection.**

v0.1.2 adds boundary detection that refuses execution when agents attempt to cross points of no return:
...
- **Core concept:** `docs/irreversible-boundaries.md` - Why boundaries, not blocklists
...
**v0.1.1 ships working protection today. No ML. No guessing. Just structural boundary enforcement.**
