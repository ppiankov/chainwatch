...
if __name__ == "__main__":
    ...
    actions = [
        Action(tool="org", resource="orgchart", operation="read", result_meta={"sensitivity":"low","rows":50}),
        Action(tool="siem", resource="siem/incidents", operation="read", result_meta={"sensitivity":"medium","rows":5000}),
        Action(tool="hr", resource="hr/salary", operation="read", result_meta={"sensitivity":"high","rows":1200}),
    ]
